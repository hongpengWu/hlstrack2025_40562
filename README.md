...
## 决赛选题为选项三
## 作品简介：
基于经典论文（https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=a665183562768e29d87ce3073fbcde564ae00768）的Unscented Kalman FIlter数学原理进行HLS代码构造。通过测试，验证了功能和相同数量级的精度；在性能，资源利用，延迟上对比官网算子更有优势；最后导出为IP核并嵌入到目标跟踪系统的PL端，与纯软件的目标跟踪系统进行直观对比，验证可行性。

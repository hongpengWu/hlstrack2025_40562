...
`timescale 1ns/1ps
module ukf_accel_step_ukf_step_3_2_s_z1_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 2,
    AddressWidth = 1,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        ukf_accel_step_ukf_step_3_2_s_z1_RAM_AUTO_1R1W_memcore ukf_accel_step_ukf_step_3_2_s_z1_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
